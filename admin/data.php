  ...
  <div class="content-header">
    <div class="container">
      <div class="row mb-4">
        ...
        <div class="col-md-1">
        <a href="../cetak/trans.php" class="btn btn-app"><i class="fa fa-print" aria-hidden="true"></i> Print</a>
        </div>
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
  </div>
    ...
    <table class="table">
      ...
      ?>
        <tr>
          ...
          <center><td>
            <a href="kelolaa.php?ubah=<?php echo $result['id']; ?>" type="submit" class="btn btn-default"><i class="fa fa-pencil" aria-hidden="true"></i></a>
            <a href="prosses2.php?hapus=<?php echo $result['id']; ?>" type="submit" class="btn btn-default" onclick="return confirm('Apakah anda yakin ingin menghapus data?')"><i class="fa fa-trash" aria-hidden="true"></i></a>
          </td></center>
      <?php } ?>
        </tr>
      </tbody>
