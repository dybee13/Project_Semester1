...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container">
      <div class="row mb-2">
        <div class="col-md-11">
          <center><h1 class="m-0 text-dark"><i class="fa fa-address-book" aria-hidden="true"></i>Data Pengguna</h1></center>
        </div>
        <div class="col-md-1">
        <a href="../cetak/user.php" class="btn btn-app"><i class="fa fa-print" aria-hidden="true"></i> Print</a>
        </div>
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
  </div>
        ...
        <div class="col-lg-12">
          <div class="card">
            ...
            <form action="prosses.php" method="post">
              <a href="kelola.php" type="submit" class="btn btn-default ml-3 mb-3"><i class="fa fa-plus" aria-hidden="true"></i> Tambah Data</a>
                    ...
                    <table class="table table-bordered table-hover table-striped" id="table">
                      <thead>
                        <tr>
                          ...
                          <center><th>Handphone</th></center>
                          <center><th>Umur</th></center>
                          <center><th>Kelamin</th></center>
                      ...
                      ?>
                        <tr>
                          ...
                          <center><td><?php echo $result['no_hp']; ?></td></center>
                          <center><td><?php echo $result['umur']; ?></td></center>
                          <center><td><?php echo $result['kelamin']; ?></td></center>
                          <center><td><img src="../Assets/img/<?php echo $result['foto']; ?>" alt="" style="width: 150px;"></td></center>
                          <center><td>
                          <a href="kelola.php?ubah=<?php echo $result['id']; ?>" type="submit" class="btn btn-default"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                          <a href="prosses.php?hapus=<?php echo $result['id']; ?>" type="submit" class="btn btn-default" onclick="return confirm('Apakah anda yakin ingin menghapus data?')"><i class="fa fa-trash" aria-hidden="true"></i></a>
                          </td></center>
                        </tr>
                        <?php
                          }
