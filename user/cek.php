                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-7" style="border-right: 1px solid black;">
                            ...
                            <a href="cart.php" class="w-100 btn btn-secondary mt-3">Cancel Checkout</a>
                        </div>
                    </div>
                    <div class="col-md-5">
                        <div class="col-12">
                            <?php
                                ...
                                $brng = mysqli_fetch_assoc($barang);
                            ?>
                                <div class="row mt-3">
                                <div class="col-4">
                                <img src="../Assets/img_barang/<?php echo $brng['foto']; ?>" style="width: 100px; height: 100px;" alt="">
                                </div>
                                <div class="col-8 mt-3">
                                <h4><?php echo $brng['nama']; ?></h4>
                                <h6 class="text-body-secondary">Quantity: <?php echo $jumlah; ?>x</h6>
                                </div>
                            </div>
                            <?php
                                }
                        ...
                        <div class="row">
                            <div class="col-md-12 mt-2">
                                ...
                                <p style="text-align: right;">Rp.<?php echo number_format($brng['harga']); ?></p>
                                </div>
                                <?php }?>
                                </div>
                                <div class="row">
                                <div class="col-md-12 mt-2">
                                    <div class="row">
                                        <div class="col-6">
                                            <label class="text-dark ml-2">Total:</label>
                                        </div>
                                        <div class="col-6">
                                        <p style="text-align: right;"><b>Rp.<?php echo number_format($_SESSION['total']); ?></b></p>
                                        </div>
                                    </div>
                                </div>
                                </div>
...
if(isset($_POST['check'])){
    ...
    foreach ($_SESSION['keranjang'] as $prod => $jumlah){
        $_SESSION['idbar'] = $prod;
        $nota = mysqli_query($konek, "SELECT * FROM barang WHERE id_barang = $prod");
        $sql = mysqli_fetch_assoc($nota);
        $foto = $sql['foto'];
        ...
        $kirimm = $asoc['nama'];
        $total = $_SESSION['total']+$asoc['harga'];
