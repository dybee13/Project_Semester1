...
<div class="content-wrapper bg-secondary">
  ...
  <div class="content-header">
    <div class="container">
      <div class="row mb-2">
        <div class="col-sm-12">
          <center><h1 class="m-0 text-light"><i class="fa fa-cubes" aria-hidden="true"></i></i>Data Barang</h1></center>
        </div>
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
  </div>
        ...
        <div class="col-lg-12">
          <div class="card">
            ...
            <form action="prossess.php" method="post">
              <a href="kelolaa.php" type="submit" class="btn btn-primary ml-3 mb-3"><i class="fa fa-plus" aria-hidden="true"></i> Tambah Data</a>
              <?php 
                if(isset($_SESSION['tambah'])):
              ?>
              <div class="alert alert-primary alert-dismissible fade show opacity-50 border-black" role="alert">
              ...
              ?>
              <div class="alert alert-success alert-dismissible fade show opacity-50 border-black" role="alert">
              <i class="fa fa-user-circle" aria-hidden="true"></i>
                <strong>
                  <?php 
                    echo $_SESSION['edit'];
              ...
              ?>
              <div class="alert alert-danger alert-dismissible fade show opacity-50 border-black" role="alert">
              <i class="fa fa-user-circle" aria-hidden="true"></i>
                <strong>
                  <?php 
                    ...
                    <table class="table table-bordered table-hover table-striped" id="table">
                      ...
                      ?>
                        <tr>
                          ...
                          <center><td>Rp.<?php echo $result['harga']; ?>,-</td></center>
                          ...
                          <center><td>
                          <a href="kelolaa.php?ubah=<?php echo $result['id']; ?>" type="submit" class="btn btn-success"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                          <a href="prossess.php?hapus=<?php echo $result['id']; ?>" type="submit" class="btn btn-danger" onclick="return confirm('Apakah anda yakin ingin menghapus data?')"><i class="fa fa-trash" aria-hidden="true"></i></a>
                          </td></center>
                        </tr>
                        <?php
                          }
