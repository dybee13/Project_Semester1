...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container">
      <div class="row mb-2">
        <div class="col-md-1">
        <a href="../admin/data_user.php" type="submit" class="btn btn-app ml-3 mb-3" onclick="return confirm('Apakah anda ingin kembali?')"><i class="fa fa-reply" aria-hidden="true"></i> Kembali</a>
        </div>
        <div class="col-md-10">
